    ...
    <section class="section" id="tutorial">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 text-center">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Information about WhatsApp admin can be seen in the footer of the page.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 text-center">
                    <div class="card">
                        <img src="images/wa_admin.jpg" class="card-img-top mx-auto d-block" style="height: 500px; alt="
                            Step 3 Image">
                        <div class="card-body">
                            <h5 class="card-title">Step 3: Choose transaction</h5>
                            <p class="card-text">Carry out transactions as desired which can be seen in the pricing menu
                            </p>
                        </div>
                    </div>
                </div>
