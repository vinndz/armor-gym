...
<div class="row">
    <div class="col-xl-4">
        ...
        <div class="card mb-4 mb-xl-0">
            ...
            <div class="card-body text-center">
                <img  class="img-account-profile mb-2 rounded-circle" src="{{ $user->image != null ? asset('storage/' . $user->image) : asset('images/profile-default.png') }}" width="150" alt="User-Profile-Image">
    ...
    <div class="col-xl-8">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" id ="user-update" action="{{ route('member.update-profile', ['id' => $user->id]) }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form method="POST" id ="user-form" action="{{ route('member.upload-profile-picture', ['id' => $user->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
