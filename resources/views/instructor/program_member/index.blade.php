            ...
            <div class="card-body ">
                ...
                <div  style="width : 100%; height : 700px; overflow : auto; ">
                    ...
                    <thead class="table-dark ">
                        ...
                        <th style="color: black;">{{ ucwords('name mmeber') }}</th>
                ...
                <div class="modal-body p-4">
                    <form  action="{{ route('program-member.store') }}" method="POST" id="add-form">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="membership_id" name="membership_id" class="form-control  @error('membership_id') is-invalid @enderror" >
                        ...
                        <div class="mb-3">
                            ...
                            <select id="program_data_id" name="program_data_id" class="form-control  @error('program_data_id') is-invalid @enderror" >
